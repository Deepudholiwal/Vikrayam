    ...
    <div class="auth-card shadow-2xl">
      ...
      <div class="auth-header">
        <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-white/20 mb-3">
          <i class="bi bi-plus-circle text-3xl text-white"></i>
        </div>
        <h3 class="text-2xl font-bold"><i class="bi bi-shop"></i> Post a New Listing</h3>
        <p class="text-white/80 text-sm mt-1">Fill in the details to create your listing</p>
      </div>
        ...
        <form method="post" enctype="multipart/form-data" novalidate>
          ...
          <div class="mb-5">
            ...
            <input name="title" id="title" type="text" 
                   ...
                   placeholder="Enter a catchy title for your listing" required>
          </div>
          ...
          <div class="mb-5">
            ...
            <textarea name="description" id="description" 
                      class="w-full px-4 py-3 border-2 border-gray-200 dark:border-gray-600 rounded-xl dark:bg-gray-700 dark:text-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition-all"
                      placeholder="Describe your listing in detail. Be specific and include important features."
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
            ...
            <div>
              <label for="location_id" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                <i class="bi bi-geo-alt"></i> Location <span class="text-red-500">*</span>
              </label>
              <select name="location_id" id="location_id" 
                ...
                <?php foreach($locs as $loc): ?>
                  <option value="<?=$loc['id']?>"><?=htmlspecialchars($loc['name'])?><?php if($loc['state']): ?> - <?=htmlspecialchars($loc['state'])?><?php endif; ?></option>
                <?php endforeach; ?>
              </select>
            </div>
          </div>
          ...
          <div class="text-center">
            <button class="w-full btn-gradient py-4 rounded-xl font-semibold text-lg inline-flex items-center justify-center gap-2" type="submit">
